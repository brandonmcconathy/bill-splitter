...
export default function Main() {
  ...
  return(
    <section className="bg-amber-200 flex flex-col justify-center items-center my-12 py-4 mx-auto gap-4 font-semibold rounded-xl box-pop w-97 sm:w-5/6 md:w-3/4 lg:w-7/12 xl:w-1/2">
